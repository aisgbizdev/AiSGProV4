...
import { pgTable, text, varchar, integer, jsonb, timestamp, date, boolean, decimal, uniqueIndex, index, uuid } from "drizzle-orm/pg-core";
...
//   id: uuid("id").primaryKey().defaultRandom(),
//   auditId: uuid("audit_id").notNull(), // Can reference audits or personal_audits (no FK constraint to allow flexibility)
